...
int main() {
    ...
    AdjacencyList Graph;
    //HardCoded for Demo
    Graph.addEdge("Ryan Reynolds", "Sandra Bullock");
    Graph.addEdge("Sandra Bullock", "George Clooney");
    Graph.addEdge("George Clooney", "Tilda Swinton");
    Graph.addEdge("Tilda Swinton", "Chris Evans");
    ...
    arrow11.setFillColor(sf::Color::Yellow);
    ...
    arrow01.setFillColor(sf::Color::Yellow);
    ...
    while (window.isOpen())
    {
        ...
        degreesOfSeparation = output.size()-1;
        //stuff always there:
        window.draw(header);
        window.draw(input1);
        window.draw(input2);
